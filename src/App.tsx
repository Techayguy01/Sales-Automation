    ...
    <div className="min-h-screen bg-white font-['Inter',sans-serif] text-gray-900">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-4">
          <a href="#" className="text-[15px] font-medium text-gray-600 hover:text-gray-900 hidden sm:block">
            Log in
          </a>
          <button className="text-[15px] font-medium text-gray-700 border border-gray-200 rounded-md px-4 py-2 hover:bg-gray-50 transition-colors">
            Book a demo
          </button>
          <button 
        ...
        <div className="w-full max-w-[480px] mx-auto">
          <div className="flex flex-col sm:flex-row gap-2 mb-6">
            <input 
              ...
              className="flex-1 px-4 py-3.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-[15px]"
            />
            <button className="px-6 py-3.5 bg-[#2563eb] text-white font-medium rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 whitespace-nowrap text-[15px]">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[13px] text-gray-500">or sign up with</span>
            <div className="flex-1 h-px bg-gray-100"></div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <span className="text-[15px] font-medium text-gray-900">Google</span>
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <span className="text-[15px] font-medium text-gray-900">Microsoft</span>
            </button>
          </div>
